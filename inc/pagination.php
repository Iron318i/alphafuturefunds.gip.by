...
if (!function_exists('alphafuturefunds_pagination')) {
     ...
     */
    function alphafuturefunds_pagination($args = array(), $class = 'pagination nav') {
	...
	$args = wp_parse_args(
	    ...
	    'mid_size' => 2,
	    'prev_next' => true,
	    'prev_text' => __('Previous page', 'alphafuturefunds'),
	    'next_text' => __('Next Page', 'alphafuturefunds'),
	    'type' => 'array',
	    'current' => max(1, get_query_var('paged')),
	    'screen_reader_text' => __('Posts navigation', 'alphafuturefunds'),
		)
	);
	...
	<nav aria-labelledby="posts-nav-label">
	    <h4 id="posts-nav-label" class="sr-only">
